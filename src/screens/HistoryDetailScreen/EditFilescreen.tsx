    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
      ...
      <View style={{ flex: 1, paddingHorizontal: 20 }}>
        <View style={{ marginTop: 20 }}>
          <View>
            <Text lineHeight={40} fontFamily="NotoSans" bold>
              {' '}
              อัพโหลดเอกสารเป็นไฟล์ภาพ
            </Text>
            <Text lineHeight={25} fontSize={14} bold color="text3">
              เพิ่มเอกสารได้สูงสุด 5 ภาพ
            </Text>
          </View>
          <View style={{ marginTop: 20 }}>
            <TouchableOpacity
              ...
              style={{
                backgroundColor:
                  file?.length === 5 ? colors.border1 : colors.primary,
                alignItems: 'center',
                paddingVertical: 12,
                borderRadius: 8,
              }}
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                />
                <Text fontFamily="NotoSans" fontSize={18} bold color="white">
                  เพิ่มเอกสาร
                </Text>
              </View>
            </TouchableOpacity>
        ...
        <View style={{ marginTop: 30, flex: 1 }}>
          ...
          <View style={{ marginTop: 20, flex: 1 }}>
            <ScrollView
                  ...
                  <View style={{ marginTop: 10 }} key={idx}>
                    <View
                      ...
                      <View style={{ flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity
                          onPress={() => openModalDelete(item.orderFileId)}>
                          <Image
                            source={icons.binRed}
              ...
              {fileUploading != undefined &&
                fileUploading?.map((item, idx) => (
                  <View style={{ marginTop: 10 }} key={idx}>
                    <View
                      style={{
                        flexDirection: 'row',
